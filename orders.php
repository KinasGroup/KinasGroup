...
// Secure: Only agents can access this page
...
// Fetch orders where the agent is the buyer
$orders = $db->prepare("
...
$pageTitle = 'My Orders - Agent Dashboard';
include __DIR__ . '/../templates/header.php';
?>
<style>
    /* Reusing styles from user/orders.php for consistency */
                ...
                <?php foreach ($orders as $order): $items = $itemsByOrder[$order['id']] ?? []; ?>
                    <div class="order-card">
                        <div class="order-head">
                            ...
                            <span class="order-status status-<?= htmlspecialchars($order['status']) ?>"><?= htmlspecialchars(ucfirst($order['status'])) ?></span>
                        </div>
