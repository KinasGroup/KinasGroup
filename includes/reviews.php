...
<div class="kr-reviews-list" id="krReviewsList">
    ...
    <div class="kr-review" data-review-id="<?= $rid ?>">
        <div class="kr-review-head">
            <div>
                <span class="kr-review-user"><?= htmlspecialchars($review['user_name'] ?? 'Customer', ENT_QUOTES, 'UTF-8') ?></span>
...
<div class="kr-form-wrap">
    ...
    <form id="krReviewForm">
        ...
        <div class="kr-note">Reviews are moderated. Approved reviews will appear publicly on this product page.</div>
