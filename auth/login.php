        ...
        document.getElementById('loginForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (data.error_code === 'email_not_verified') {
                    const message = (data.error || 'Please verify your email.') + ' Would you like us to send a new verification link to ' + (data.email || email) + '?';
                        ...
                        window.kinasConfirm(
                            ...
                            async function() {
                                try {
                                    ...
                                    window.showNotification(rd.message || 'If that email is registered and unverified, a new link has been sent.', 'success');
                                } catch (err) {
