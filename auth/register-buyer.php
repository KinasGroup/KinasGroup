...
if (!name || !username || !email || !phone || !password || !passwordConfirmation) { kinasToast('Please fill in all required fields', 'error'); return; }
...
body: JSON.stringify({
name, username, email, phone, password, password_confirmation: passwordConfirmation,
