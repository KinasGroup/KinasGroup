...
try {
    ...
    if ($status === 'deleted') {
        ...
        // Only self-deleted accounts can be reactivated via login.
        if ($deletedBy === 'self') {
            ...
            unset(
                ...
                $_SESSION['user_role'], $_SESSION['user_verified'], $_SESSION['logged_in'],
                $_SESSION['user_division'], $_SESSION['is_super_agent'], $_SESSION['csrf_token']
            );
        ...
        // Admin-deleted accounts are blocked
