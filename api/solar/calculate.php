...
try {
    ...
    // The quotation now covers SOLAR HARDWARE ONLY.
    // ============================================================
    $panelPrice = 450000;
    ...
    $otherCosts = 0;                 // services excluded (not offered)
    $estimatedCost = $hardwareSubtotal;
...
<strong>Estimated Investment (Hardware):</strong> ₦' . number_format($estimatedCost) . '<br>
...
<strong>Estimated Cost (Hardware):</strong> ₦' . number_format($estimatedCost) . '<br>
<strong>Monthly Savings:</strong> ₦' . number_format($monthlySavings) . '
</div>
