...
*
* AMENDED: counterpart names returned to the client are the PUBLIC
...
try {
// AMENDED: usernames selected for public identity display.
$stmt = $db->prepare("
SELECT m.*,
...
$otherUsername = $isMine ? ($m['receiver_username'] ?? null) : ($m['sender_username'] ?? null);
...
'other_name'        => kinas_public_display_name($otherUsername, $otherName !== '' ? $otherName : 'Unknown'),
