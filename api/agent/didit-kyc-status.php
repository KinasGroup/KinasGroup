...
* - Exposes KYC name-match state where supported by the schema.
* - Gives a clearer rejection message when the ID name does not match
*   the registered account name.
* - Remains backward compatible if the newer columns are not present.
*/
...
// More precise messages for name-match problems.
