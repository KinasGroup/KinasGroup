...
*
* AMENDED: reviewer identity is now the PUBLIC username (@username);
* legal names are never exposed through this endpoint.
*/
...
// AMENDED: public identity (@username), legal name only as fallback.
'user_name' => kinas_public_display_name($review['user_username'] ?? null, $review['user_name'] ?? 'Customer'),
