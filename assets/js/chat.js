...
//
// FIX APPLIED:
// - Removed '@' prefix from all username displays and avatar initials.
//   Added cleanName() helper that strips leading '@' symbols.
...
// ============================================================
// FIX: Strip leading '@' from usernames for display.
// E-commerce platforms show clean usernames without '@'.
// ============================================================
...
// ============================================================
var SOUND_STORAGE_KEY = 'kinas_chat_sound_enabled';
...
function updateSoundToggleIcon() {
    ...
    if (state.soundEnabled) {
        ...
        btn.title = 'Notification sound: ON — click to mute';
        btn.classList.remove('is-muted');
    } else {
        icon.className = 'fas fa-volume-xmark';
        btn.title = 'Notification sound: OFF — click to unmute';
        ...
        '<div class="chat-list-pane">' +
            '<div class="chat-list-head">' +
                '<div class="chat-list-title">' +
                    ...
                    '<span class="chat-list-count" id="chatListCount"></span>' +
                '</div>' +
                '<button type="button" class="chat-sound-toggle" id="chatSoundToggle" title="Notification sound">' +
...
var app = qs('chatApp'),
    ...
    soundToggleBtn = qs('chatSoundToggle');
