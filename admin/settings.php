    ...
    if (!Security::verifyCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        if (strlen($new) < 8) {
            ...
            if (!password_verify($cur, $hash)) {
                ...
                Security::logActivity($_SESSION['user_id'], 'password_changed', 'Admin changed own password');
...
.form-group input[type="text"], .form-group input[type="url"], .form-group input[type="password"] {
    width: 100%;
    padding: 10px 14px;
...
@media (prefers-color-scheme: dark) {
    ...
    .je-password-toggle { color: #888 !important; }
    .je-password-toggle:hover { color: #C6A43F !important; }
}
</style>
...
<main class="je-dash-main">
    <div class="admin-container">
        ...
        <div class="settings-card">
            <div class="card-header"><i class="fas fa-lock"></i><h2>Change Admin Password</h2></div>
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="je-password-wrap">
                            ...
                            <button type="button" class="je-password-toggle" aria-label="Show password"><i class="fas fa-eye"></i></button>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
