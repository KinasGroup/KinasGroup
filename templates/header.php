...
// Legacy session from before usernames existed — resolve once, then cache.
try {
...
$whatsappLoggedIn = $isLoggedIn; // <-- NEW: gate
...
<?php endif; ?>
<!-- ============================================================ -->
<!-- WHATSAPP CSS (loaded for everyone; the button itself is gated) -->
<!-- ============================================================ -->
