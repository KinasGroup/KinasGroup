...
// Load user row.
$userStmt = $db->prepare("
    SELECT id, name, username, email, phone, role, status, verified, division, avatar, created_at
    FROM users
    WHERE id = ?
");
            ...
            <div class="stats-row">
                ...
                <div class="stat-mini">
                    ...
                    <div class="info">
                        ...
                        <small>Inquiries received</small>
                    </div>
                </div>
            ...
            <form class="profile-grid" method="POST" action="/api/agent/update-profile.php" enctype="multipart/form-data" id="profileForm">
                ...
                <div class="profile-card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?= htmlspecialchars($usernameDisplay) ?>" readonly placeholder="Not set">
                        <div class="photo-note">Your unique public identity. It cannot be changed.</div>
                    </div>
                ...
                <div class="profile-card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="company_legal_name" value="<?= htmlspecialchars($profile['company_legal_name'] ?? '') ?>" placeholder="Registered legal company name">
                    </div>

                    <div class="form-row">
                        <div class="form-group">
                            <label>CAC Number</label>
                            <input type="text" name="cac_number" value="<?= htmlspecialchars($profile['cac_number'] ?? '') ?>" placeholder="e.g., RC123456">
                        </div>

                        <div class="form-group">
                            <label>TIN</label>
                            <input type="text" name="tin" value="<?= htmlspecialchars($profile['tin'] ?? '') ?>" placeholder="Tax Identification Number">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label>Tax ID</label>
                            <input type="text" name="tax_id" value="<?= htmlspecialchars($profile['tax_id'] ?? '') ?>" placeholder="Optional tax ID">
                        </div>

                        <div class="form-group">
                            <label>Company Email</label>
                            <input type="email" name="company_email" value="<?= htmlspecialchars($profile['company_email'] ?? '') ?>" placeholder="business@company.com">
                        </div>
                    </div>
