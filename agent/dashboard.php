...
// Allowed listing divisions for this agent (admin gets all)
$dashAllowed = SessionManager::getAllowedDivisions();
...
<div class="agent-main">
    <div class="agent-container">
        ...
        <div class="quick-actions">
            <?php
            // Show the "Add" cards only for divisions the agent is allowed to post in.
            $dashListings = [
                'car'         => ['icon' => 'fa-car',          'label' => 'Add Car Listing',  'title' => 'Add a vehicle listing'],
                'property'    => ['icon' => 'fa-home',         'label' => 'Add Property',     'title' => 'Add a property listing'],
                'solar'       => ['icon' => 'fa-solar-panel',  'label' => 'Add Solar/Volt',   'title' => 'Add a solar installation'],
                'marketplace' => ['icon' => 'fa-store',        'label' => 'Add Marketplace',  'title' => 'Add a curated item'],
            ];
            $dashListingToDivision = [
                'car'         => 'automobile',
                'property'    => 'real_estate',
                'solar'       => 'solar',
                'marketplace' => 'marketplace',
            ];
            foreach ($dashListings as $lt => $info):
                $divKey = $dashListingToDivision[$lt];
                if (!in_array($divKey, $dashAllowed, true)) continue;
            ?>
            <a href="/agent/add-listing.php?type=<?= htmlspecialchars($lt) ?>" class="action-card" title="<?= htmlspecialchars($info['title']) ?>">
