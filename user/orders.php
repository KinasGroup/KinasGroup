 ...
 *
 * ALIGNED (review process flow):
 * - "Leave Review" is only offered once the order item is Delivered
 *   (or the order is Completed/Delivered). Before that, a neutral
 *   "Review after delivery" badge is shown instead.
 */
...
/* ALIGNED: neutral badge shown before delivery (review not yet open) */
.review-locked {
    background: #ECEFF1;
    color: #546E7A;
    cursor: default;
...
@media (prefers-color-scheme: dark) {
    ...
    .review-locked { background: #ECEFF1 !important; color: #546E7A !important; }
}
</style>
...
// ALIGNED: reviews open only once the item is delivered (or the order
// itself is completed/delivered), matching the review process flow.
$itemReviewable = ($it['shipping_status'] ?? 'pending') === 'delivered'
...
<?php else: ?>
<span class="review-badge review-locked" title="You can review this item once it is delivered">
<i class="fas fa-truck"></i> Review after delivery
</span>
<?php endif; ?>
<?php endif; ?>
