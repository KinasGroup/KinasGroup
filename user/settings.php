...
/**
* KINAS GROUP — User Settings
*
* AMENDED:
* - Delete Account button changed from kinasConfirm() (which may not
*   be loaded) to a direct link to /user/delete-account.php.
* - Danger zone text updated to reflect soft delete / reactivation.
*/
...
.danger-zone p{color:#666;font-size:13px;margin-bottom:16px;line-height:1.6}
.btn-danger{background:#DC2626;color:white;border:none;padding:12px 24px;border-radius:40px;cursor:pointer;font-weight:600;text-decoration:none;display:inline-flex;align-items:center;gap:8px;transition:background .2s}
...
Your listings, saved items, and enquiry history will no longer be visible.
