...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!Security::verifyCSRFToken($_POST['csrf_token'] ?? '')) {
        ...
        // FIX: Separate profile updates from password updates
...
.je-form-group textarea:focus {
    outline: none;
    border-color: #C6A43F;
    box-shadow: 0 0 0 3px rgba(198,164,63,0.08);
}
.je-form-group input[readonly],
.je-form-group input[disabled] {
    background: #f7f7f7;
    color: #999;
    cursor: not-allowed;
}
                ...
                <div class="profile-banner-info">
                    ...
                    <div class="profile-banner-badges">
                        ...
                        <?php if ($usernameDisplay !== ''): ?>
                            <span class="profile-badge badge-buyer"><?php echo htmlspecialchars($usernameDisplay); ?></span>
                        <?php endif; ?>
                        ...
                        <div class="profile-card-body">
                            <div class="form-grid single" style="margin-bottom:16px;">
                                <div class="je-form-group">
                                    ...
                                    <input type="text" value="<?php echo htmlspecialchars($usernameDisplay); ?>" readonly placeholder="Not set">
                                    <div class="je-form-hint">Your unique public identity. It cannot be changed.</div>
                                </div>
                            </div>
                            <div class="form-grid" style="margin-bottom:16px;">
                                <div class="je-form-group">
                                    <label>Full Name *</label>
                                    <input type="text" name="name" value="<?php echo htmlspecialchars($user['name']); ?>" required placeholder="Your full name">
                                </div>
                                <div class="je-form-group">
                                    <label>Phone Number</label>
                                    <input type="tel" name="phone" value="<?php echo htmlspecialchars($user['phone'] ?? ''); ?>" placeholder="+234 000 000 0000">
                                </div>
                            </div>
                            <div class="form-grid single" style="margin-bottom:16px;">
                                <div class="je-form-group">
                        ...
                        <div class="profile-card-body">
                            <div class="form-grid" style="margin-bottom:4px;">
                                ...
                                <div class="je-form-group">
                                    ...
                                    <div class="je-password-wrap">
                                        <input type="password" name="new_password" minlength="8" autocomplete="new-password" placeholder="Minimum 8 characters" id="new-pw-input">
                                        <button type="button" class="je-password-toggle" aria-label="Show password" aria-pressed="false" tabindex="0">
                                            <i class="fas fa-eye" aria-hidden="true"></i>
                                        </button>
                                    </div>
                ...
                function() {
                    kinasConfirm(
                        ...
                        },
                        {
                            ...
                            warning: 'There is no recovery after this step.'
                        }
                    );
                },
                {
