...
// ============================================================
// Instead of always showing the same featured/latest marketplace items,
// rotate through all active marketplace listings.
// ============================================================
$items = kinas_get_rotated_marketplace($db, 12);
