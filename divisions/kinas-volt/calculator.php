<?php
// calculator.php — DUAL-OPTION rebuild (Option B: shows both options equally)
...
.remove-appliance i { font-size: 14px; color: #ff6b6b !important; }
.remove-appliance:hover i { color: #ff4757 !important; }
...
/* =========================================
   INJECTION: DUAL-OPTION (OPTION B) CSS
   ========================================= */
...
font-size: 18px !important; background: rgba(255,255,255,0.05) !important;
}
...
if (names[i].value && watts[i].value) { hasAppliance = true; break; }
}
if (!hasAppliance) { showError('Please add at least one appliance.'); return; }
hideError();
}
...
/* =========================================
   INJECTION: DUAL-OPTION (OPTION B) RENDERER
   ========================================= */
...
if (data.options) {
// ---- NEW DUAL-OPTION LAYOUT (Option B) ----
...
// ---- LEGACY SINGLE-BUNDLE FALLBACK (old API response shape) ----
let itemsHtml = '';
