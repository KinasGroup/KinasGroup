...
<section id="heroSection">
    ...
    <div class="je-container" style="color:#fff; position:relative; z-index:1;">
        ...
        <div class="je-flex" style="gap:14px;">
            ...
            <a href="rental-search.php" class="je-btn je-btn-lg" style="background:transparent;border-color:rgba(255,255,255,0.3);color:#fff;"><i class="fas fa-key"></i> Car Rentals</a>
        </div>
    </div>
</section>
