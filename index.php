    ...
    <div class="container">
        <div class="trust-row">
            <div class="trust-item">
                <img src="/assets/images/trust/verified-badge.png" alt="Verified Agents" style="height:60px; width:auto; margin-bottom:15px; object-fit:contain;">
                <h4>Verified Agents</h4>
                <p>All agents undergo KYC verification</p>
            </div>
            <div class="trust-item">
                <img src="/assets/images/trust/secure-payment.png" alt="Secure Transactions" style="height:60px; width:auto; margin-bottom:15px; object-fit:contain;">
                <h4>Secure Transactions</h4>
                <p>Your safety is our priority</p>
            </div>
            <div class="trust-item">
                <img src="/assets/images/trust/magnifying-glass.png" alt="Quality Assurance" style="height:60px; width:auto; margin-bottom:15px; object-fit:contain;">
                <h4>Quality Assurance</h4>
                <p>Every listing reviewed by our team</p>
            </div>
            <div class="trust-item">
                <img src="/assets/images/trust/world-map-phone.png" alt="Global Reach" style="height:60px; width:auto; margin-bottom:15px; object-fit:contain;">
                <h4>Global Reach</h4>
